...
const Map = {
    ...
    load: function() {
        // Lazy-load Leaflet to reduce initial bundle size
        if (!this.L) {
            import(/* webpackChunkName: "leaflet" */ "leaflet").then((Lmod) => {
                this.L = Lmod && Lmod.default ? Lmod.default : Lmod;
                this._initMap();
    ...
    _initMap: function() {
        ...
        // IMPORTANT: replace `YOUR_MAPBOX_ACCESS_TOKEN` with your Mapbox token at runtime.
        // Do NOT commit secrets to the repository.
        const mapboxToken = process.env.MAPBOX_TOKEN || 'YOUR_MAPBOX_ACCESS_TOKEN';
    ...
    plotMarker: function() {
        ...
        this.svg = select("#map").select("svg").attr("class", "map_svg");
